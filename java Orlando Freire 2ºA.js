...
var edad1 = ("Tu edad es " + edad);
document.write(edad1);
var colorDePelo = prompt("¿Cuál es el color de tu pelo?");
var pelo1 = (". Tu color de pelo es " + colorDePelo);
document.write(pelo1);
...
function preguntarIrALink() {
   ...
   var confirmacion = confirm("¿Quieres ir a google.com?");
